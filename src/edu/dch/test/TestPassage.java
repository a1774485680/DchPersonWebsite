...
public class TestPassage {
	...
	public void testone() {
			...
			passdao.insertpassage(new Passage(3,"sa","c:/sa/sa/sa/sa","测试","2019/4/1","spring","这个简介很简短",12,12,true));
	...
	@Test
	public void test09() {
		passdao.updatepassage(new Passage(6,"sa","c:/sa/sa/sa/sa","哈哈哈，测试","2019/4/1","spring","这个简介很简短",12,12,false));
	}
	@Test
	public void test10() {
